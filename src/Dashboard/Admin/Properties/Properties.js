...
import AdminAddProperty from "./Add Property"
...
const Properties = () => 
{
    ...
    //State to store all the owners
    const [owners, setOwners] = useState([])

    //State for the add property modal
    ...
    return ( 
        <div className="container mt-2">
            ...
            {
                showAddPropertyModal && <AdminAddProperty addModal={showAddPropertyModal} setAddModal={setShowAddPropertyModal} fetchProperties={fetchProperties} owners={owners}/>
            }
        </div>
     );
}
