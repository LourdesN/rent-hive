...
const Login = () => 
{
  ...
  return (
    <div className="container-fluid vh-100 d-flex flex-column align-items-center justify-content-center login-backgound">
        ...
        <div className="card shadow-sm" style={{ maxWidth: "400px", width: "100%", marginTop: "3rem" }}>
          <img src={Logo} alt="Rent Hive Logo" className="w-100" style={{ height: "250px", objectFit: "contain", border: "1px solid red" }} />
          <form onSubmit={submitLogin} className="p-3">
            ...
            <div className="mb-3 position-relative">
                ...
                <span className="position-absolute end-0 top-55 translate-middle-y me-3 cursor-pointer" onClick={toggleVisibility}
