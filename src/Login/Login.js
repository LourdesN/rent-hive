...
const Login = () => 
{
  ...
  return (
    <div className="container-fluid vh-100 d-flex flex-column align-items-center justify-content-center login-backgound">
        ...
        <div className="card shadow-sm p-4" style={{ maxWidth: "200px", width: "100%", marginTop: "3rem" }}>
          <form onSubmit={submitLogin}>
            <img src={Logo} alt="Rent Hive Logo" className="w-100" style={{ height: "450px", objectFit: "contain" }} />
            <div className="mb-3">
